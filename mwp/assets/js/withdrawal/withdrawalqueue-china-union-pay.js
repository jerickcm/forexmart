$(function(){
    ...
    $(document).ready(function(){
        ...
        $('.withdrawalqueue-table-china-union-pay').DataTable({
            dom: 'ltip',
            processing : true,
            serverSide: true,
            responsive: true,
            ...
            ajax:{
                type: 'post',
                url: site_url+'withdrawalqueue/GetWithdrawalTransactionUP',
                showLoader: true,
                data: function(d){
                    d.tab = $('.queue-tab-list .active').attr('id');
                    d.activeTransaction = 'UP';
                    return d;
                },
        ...
        $('#request-table-china-union-pay').DataTable().draw();
