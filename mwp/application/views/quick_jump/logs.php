...
<section class="content-header">
    <h1>Manage Logs</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-shield"></i> Manage Logs</li>
    </ol>
</section>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        showloader();
        maintable = $('#monitor_profit').DataTable( {
            "order": [[ 4, "desc" ]],
            searchDelay: 2000,
            "fnDrawCallback": function( oSettings ) {   hideloader();  },
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": site_url+"manage-logs/get_log",
                "type": "POST",
                "beforeSend": function (xhr, opts) {    },
                "timeout": 5000000, // optional if you want to handle timeouts (which you should)
                "error": handleAjaxError // this sets up jQuery to give me errors
            },
            "columns": [
                { "data": "admin_email" },
                { "data": "admin_fullname" },
                { "data": "processed_users_id_accountnumber" },
                { "data": "page" },
                { "data": "date_processed" },
                { "data": "data" }
            ]
