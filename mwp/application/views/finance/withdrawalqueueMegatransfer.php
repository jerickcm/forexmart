            ...
            <div class="tab-content acct-cont admin-tab-cont">
                <div role="tabpanel" class="tab-panel-withdrawalqueue Request">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-banktransfer" id="request-table-banktransfer">
                            <thead>
                            <tr role="row">
                ...
                <div role="tabpanel" class="tab-panel-withdrawalqueue Processed" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-striped queue-tab withdrawalqueue-table-banktransfer">
                            <thead>
                            <tr role="row">
                                <th tabindex="0" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 295px;">Reference No.</th>
                                <th tabindex="0" rowspan="1" colspan="1" style="width: 361px;">Client's Name</th>
...
//        $(document).ready(function(){
            ...
            $('.withdrawalqueue-table-banktransfer').DataTable({
                ...
                ajax:{
                    type: 'post',
                    url: "<?php echo FXPP::ajax_url('Withdrawal_queue/GetWithdrawalTransactionMT')?>//",
                    showLoader: true,
                    data: function(d){
                        d.tab = $('.queue-tab-list .active').attr('id');
                        d.activeTransaction = 'MT';
                        return d;
                    },
            ...
            $('#request-table-banktransfer').DataTable().draw();
