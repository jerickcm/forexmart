            ...
            <div class="tab-content acct-cont admin-tab-cont">
                <div role="tabpanel" class="tab-panel-withdrawalqueue Request" id="withdrawalqueue-request">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-neteller" id="request-table-neteller">
                            <thead>
                            <tr role="row">
                            ...
                            <tbody id="nt-Request-tbody"></tbody>
                        </table>
                    </div>
                </div>
                <div role="tabpanel" class="tab-panel-withdrawalqueue Processed" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-neteller">
                            <thead>
                            <tr role="row">
                                <th tabindex="0" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 295px;">Reference No.</th>
                                <th tabindex="0" rowspan="1" colspan="1" style="width: 361px;">Client's Name</th>
                ...
                <div role="tabpanel" class="tab-panel-withdrawalqueue Declined" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-neteller">
                            ...
                            <tbody id="nt-Declined-tbody"></tbody>
                        </table>
                    </div>
                </div>
            </div>
...
//        $(document).ready(function(){
            ...
            $('.withdrawalqueue-table-neteller').DataTable({
                dom: 'ltip',
                processing : true,
                serverSide: true,
                responsive: true,
                ...
                ajax:{
                    type: 'post',
                    url: "<?php echo FXPP::ajax_url('Withdrawal_queue/GetWithdrawalTransactionNT')?>//",
                    showLoader: true,
                    data: function(d){
                        d.tab = $('.queue-tab-list .active').attr('id');
                        d.activeTransaction = 'NT';
                        return d;
                    },
            ...
            $('#request-table-neteller').DataTable().draw();
