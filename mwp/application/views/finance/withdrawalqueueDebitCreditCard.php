            ...
            <div class="tab-content acct-cont admin-tab-cont">
                <div role="tabpanel" class="tab-panel-withdrawalqueue Request" style="display:block;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-credit-card" id="request-table-credit-card">
                            <thead>
                            <tr role="row">
                ...
                <div role="tabpanel" class="tab-panel-withdrawalqueue Processed" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-credit-card">
                            <thead>
                            <tr role="row">
                                <th tabindex="0" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 295px;">Reference No.</th>
                                <th tabindex="0" rowspan="1" colspan="1" style="width: 361px;">Client's Name</th>
                            ...
                            <tbody id="cc-Processed-tbody"></tbody>
                        </table>
                    </div>
                </div>
                <div role="tabpanel" class="tab-panel-withdrawalqueue Declined" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-credit-card">
                            ...
                            <tbody id="cc-Declined-tbody"></tbody>
                        </table>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $('.withdrawalqueue-table-credit-card').DataTable({
            dom: 'ltip',
            processing : true,
            serverSide: true,
            responsive: true,
            ...
            ajax:{
                type: 'post',
                url: "<?php echo FXPP::ajax_url('Withdrawal_queue/GetWithdrawalTransactionCC')?>//",
                showLoader: true,
                data: function(d){

                    d.tab = $('.queue-tab-list .active').attr('id');
                    d.activeTransaction = 'CC';
                    return d;
        ...
        $('#request-table-credit-card').DataTable().draw();
