...
//        $(document).ready(function(){
            ...
            $('.withdrawalqueue-table-banktransfer').DataTable({
                ...
                ajax:{
                    type: 'post',
                    url: "<?php echo FXPP::ajax_url('Withdrawal_queue/GetWithdrawalTransactionBC')?>//",
                    showLoader: true,
                    data: function(d){
                        d.tab = $('.queue-tab-list .active').attr('id');
                        d.activeTransaction = 'BC';
                        return d;
                    },
                    ...
                    bootbox.confirm({
                        ...
                        callback: function (result) {
                            if(result){
                                $.ajax({
                                    type: 'POST',
                                    url: 'https://m7.forexmart.com/Withdrawal_queue/all_withdrawalqueue_update',
