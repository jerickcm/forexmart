...
<div class="col-lg-12 col-md-12 col-sm-12">
    <div class="section">
        <div id="withdrawal-panel-creditcard" class="withdrawal-panel creditcard">
            ...
            <div class="tab-content acct-cont admin-tab-cont">
                <div role="tabpanel" class="tab-panel-withdrawalqueue Request" id="withdrawalqueue-request">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-paxum" id="request-table-paxum">
                            <thead>
                            <tr role="row">
                            ...
                            <tbody id="px-Request-tbody"></tbody>
                        </table>
                    </div>
                </div>
                <div role="tabpanel" class="tab-panel-withdrawalqueue Processed" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-paxum">
                            <thead>
                            <tr role="row">
                                <th tabindex="0" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 295px;">Reference No.</th>
                                <th tabindex="0" rowspan="1" colspan="1" style="width: 361px;">Client's Name</th>
                            ...
                            <tbody id="px-Processed-tbody"></tbody>
                        </table>
                    </div>
                </div>
                <div role="tabpanel" class="tab-panel-withdrawalqueue Declined" style="display: none;">
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped dataTable style-form-table last-mid-table-head double-column-table-head queue-tab withdrawalqueue-table-paxum">
                            ...
                            <tbody id="px-Declined-tbody"></tbody>
                        </table>
                    </div>
                </div>
            </div>
...
//        $(document).ready(function(){
            ...
            $('.withdrawalqueue-table-paxum').DataTable({
                dom: 'ltip',
                processing : true,
                serverSide: true,
                responsive: true,
                ...
                ajax:{
                    type: 'post',
                    url: "<?php echo FXPP::ajax_url('Withdrawal_queue/GetWithdrawalTransactionPX')?>//",
                    showLoader: true,
                    data: function(d){
                        d.tab = $('.queue-tab-list .active').attr('id');
                        d.activeTransaction = 'PX';
                        return d;
                    },
            ...
            $('#request-table-paxum').DataTable().draw();
