...
<div class="error-main-holder">
    <div class="error-header-holder">
        <div class="error-logo-holder">
            <a href="https://www.forexmart.com"><img src="https://www.forexmart.com/assets/images/logo5.svg" class="img-responsive error-logo"></a>
        </div>
    </div>
    <div class="error-content-holder">
        <div class="error-content-holder">
            <img src="https://www.forexmart.com/assets/images/error500.png" class="img-responsive error-cont">
    ...
    <div class="error-img-holder">
        <div class="error-logo-holder">
            <img src="https://www.forexmart.com/assets/images/error-img.png" class="img-responsive error-img">
        </div>
    </div>
...
<!-- jQuery -->
<script src="https://www.forexmart.com/assets/js/jquery.js"></script>

<!-- Bootstrap Core JavaScript -->
<script src="https://www.forexmart.com/assets/js/bootstrap.min.js"></script>

<!-- Scrolling Nav JavaScript -->
<script src="https://www.forexmart.com/assets/js/jquery.easing.min.js"></script>
<script src="https://www.forexmart.com/assets/js/scrolling-nav.js"></script>
