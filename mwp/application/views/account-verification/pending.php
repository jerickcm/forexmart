...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        maintable =$('#AccountsTable').DataTable( {
            ...
            "ajax": {
                "url": site_url+"account-verification/get-pending",
                "type": "POST",
...
//                "success": fnCallback,
    ...
    function UpdateRequest(){
        ...
        pblc['request'] = $.ajax({
            dataType: 'json',
            url: site_url+"account-verification/AV_updaterequest",
            method: 'POST',
            data: prvt["data"]
        });
