...
<div class="wrapper-body" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;padding: 10px 0;margin-top: 3px;border-top: 1px solid #2988ca;border-bottom: 1px solid #2988ca;padding-bottom: 20px;">
    ...
    <div class="content-grid"
        ...
        <br>
        <a href="https://www.forexmart.com/mwp/" target="_blank" style="margin-left:52px;width: 300px; background: green none repeat scroll 0% 0%; color: white; border: 1px solid green; text-decoration: none; padding: 9px 50px;">Login to Admin Panel</a>
        <br>
        <p style=" margin-top: 30px !important;font-size: 14px;font-family: Arial;font-weight: 400;color: #555;margin-top: 15px;text-align: justify;line-height: 19px;">Alternatively, you may copy and paste the following link to your browser <a>https://www.forexmart.com/mwp/</a></p>
        

        <p style="margin: 0 auto;font-size: 14px;font-family: Arial;font-weight: 400;color: #555;margin-top: 15px;text-align: justify;line-height: 19px;">Please store your login details safe and secure at all times.</p>
        <p style="margin: 0 auto;font-size: 14px;font-family: Arial;font-weight: 400;color: #555;margin-top: 15px;text-align: justify;line-height: 19px;">Note that your login and password will work Forexmart only.</p>
