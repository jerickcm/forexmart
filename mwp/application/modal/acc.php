    ...
    <div class="modal-dialog modal-lg round-0">
        <div class="modal-content round-0">
            ...
            <div class="modal-body">
                Account is Verified.
                Verified account is moved <a href="<?= $this->config->item('domain-m7');?>/administration/accountverification-verified-documents" >here</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="Dec" tabindex="-1" role="dialog" aria-labelledby="">
    <div class="modal-dialog modal-lg round-0">
        <div class="modal-content round-0">
            ...
            <div class="modal-body">
                Account is Declined.
                Declined account is moved <a href="<?= $this->config->item('domain-m7');?>/administration/accountverification-unverified-documents" >here</a>
            </div>
        </div>
    </div>
</div>
