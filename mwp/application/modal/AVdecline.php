...
<div class="modal fade" id="popAccountVerificationDecline" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 100%;">
        ...
        <div  class="modal-content round-0 modalfeedbackcontent">
            <div class="modal-header popheader">
                ...
                <div class="modal-title poptitle" id="myModalLabel">
                    <img src="<?= $this->template->Images()?>logo1.png" alt="logo" class="img-reponsive">
                </div>
            </div>

            <?= form_open('administration/AccountVerificationDecline',array('id' => 'form_Schemedelete')); ?>
