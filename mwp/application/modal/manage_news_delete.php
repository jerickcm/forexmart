...
<div class="modal fade" id="newsDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog round-0 ">
        <div  class="modal-content round-0 modalfeedbackcontent">
            ...
            <?= form_open('administration/delete_news',array('id' => 'form_delete')); ?>
            <div class="modal-body modal-body1">
                <p class="check-ps">Are you sure you want to delete this news?</p>
                <input type="hidden" name="delete_news_id" id="deleteNewsId" value=""/>
            </div>
