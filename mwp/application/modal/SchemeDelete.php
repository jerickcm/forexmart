...
<div class="modal fade" id="popSchemedelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog round-0 ">
        <div  class="modal-content round-0 modalfeedbackcontent">
            ...
            <?= form_open('administration/settingsschemedelete',array('id' => 'form_Schemedelete')); ?>
                <div class="modal-body modal-body1">
                    <p class="check-ps"> Are you sure you want to delete "<span id="scheme_title_modal"></span>" from the list? </p>
