...
class Template
{
    ...
    private $_metadata_js = array();
    private $_metadata_css = array();
	...
	public function build($view, $data = array(), $return = FALSE)
	{
        ...
        $template['metadata_css']	= implode("\n\t\t", $this->_metadata_css);
        $template['metadata_js']	= implode("\n\t\t", $this->_metadata_js);
    ...
    public function append_metadata_js($line)
    {
        $this->_metadata_js[] = $line;
        return $this;
    }
    public function append_metadata_css($line)
    {
        $this->_metadata_css[] = $line;
        return $this;
    }
	...
	public function Fonts(){
		return  base_url().'assets/font-awesome/';
	}
    ...
    public function pdfviewer(){
		return  base_url().'assets/web/viewer.html';
    }

    public function zip(){
        return  base_url().'assets/zip/';
    }

	public function Images(){
		return  base_url().'assets/images/';
	}
	public function MarkItUp(){
		return  base_url().'assets/markitup/';
	}
	public function Img(){
