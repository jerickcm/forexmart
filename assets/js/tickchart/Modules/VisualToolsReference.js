...
WC.VT.VisualToolsBase = function (chartInstance, ContainerID, ChartDisplayInstance) {
    ...
    vtBase.FireMouseDown = function (X, Y) {
        vtBase.Selector.trigger($.Event('mousedown', { offsetX: X, offsetY: Y, originalEvent: {} }));
    }
    vtBase.FireMouseUp = function () {
        vtBase.Selector.trigger('mouseup');
    }
