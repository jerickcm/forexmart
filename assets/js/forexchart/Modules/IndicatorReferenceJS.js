...
var WorkerPath = 'assets/js/forexchart/Modules/Worker.js';
...
WC.IN.BaseIndicator = function (chartInstance, ContainerID, ChartDisplayInstance, Options) {
    ...
    //Load OnBars
    BaseIndicator.LoadOnBarsIndicator = function (IndicatorName, Bars, Options) {
        LoadIndicatorFunction(IndicatorName, Bars, Options, false, null, null);
    }

    var ctxMenuObj = BaseIndicator.ContextMenuObject(null, null);

    function LoadIndicatorFunction(IndicatorName, Bars, Options, LoadSession, IndicatorSessionID, index) {
        var newIndicator;
