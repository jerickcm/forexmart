...
WC.Init = function () {
    ...
    //For Standalone
    //Note: Timeframe values must converted in minute value. 
    ...
    //        StopLimitOrders: DD.StopLimitOrders,
    //        OpenTrades: DD.OpenTrades,
    ...
    //        IsVisualToolsVisible: true,
    //        IsChartObjectsVisible: true,
    ...
    //For TiChart Tester
    var tickchart = new WC.CM.TickChart("wc-ohlc-chart", {
//        Symbol: "SymbolXXX",
//        Symbol: "AUDUSD",
        Symbol: first_symbol,
    ...
    WC.OnLayout.push(function () { tickchart.RefreshChart() });
