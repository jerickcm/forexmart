...
class Thirty_percent_bonus extends MY_Controller {
	public function __construct(){
		parent::__construct();
		$this->lang->load('tpdepositbonus');
	}
	public function index(){
		//$data['data']['metadata_description'] = lang('tpdb_dsc');
        $data['data']['metadata_description'] = '';
		$data['data']['metadata_keyword'] = lang('tpdb_kew');
		...
		$this->template->title(lang('tpdb_tit'))
