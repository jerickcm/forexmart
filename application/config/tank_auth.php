...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'ForexMart';
$config['webmaster_email'] = 'noreply@mail.forexmart.com';
...
$config['recaptcha_public_key'] = '6LdUtxETAAAAAEdaNbFR-rtlyfd6YYTdLJXurEkf';
$config['recaptcha_private_key'] = '6LdUtxETAAAAACJS1VUbWJO1UYqzJKYRj5MhN6vW';
