                            ...
                            <div class="table-responsive">
                                <table class="table table-stripped calendar-tab table-hover">
                                   ...
                                   // var_dump($cnt);date_format($date,"H:i")
                                    ?>
                                    <tr>
                                        <td colspan="7" class="ec-date"><?=$xml->channel->item[0]->date;?></td>
                                    </tr>
                                    ...
                                    for($i=0; $i<$cnt; $i++)
                                    {
                                     ...
                                     ?>
                                        ...
                                        <tr>
                                            <td><?=$date;?></td>
                                            <td class="f32"><i class="flag <?=$country?>"></i> <span class="country-cur"><?=$country?></span></td>
                                            <td>
                                            ...
                                            <td><a href="<?=$url?>" data-toggle="modal" data-target="#event" class="calendar-events"><?=$title?></a> <a href="#"><img src="<?= $this->template->Images()?>forex/prelim-release.png" class="prelim-release"></a></td>
                                            <td><?=$actual?></td>
                                            <td></td>
                                            <td><?=$previous?></td>
                                        </tr>
