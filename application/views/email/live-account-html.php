...
<!--                Thank you for opening an MT4 account with ForexMart! Your login details are as follows-->
            ...
            <div class="cabinet-login-details" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 30px 20px; width: 100%; text-align: center;">
...
<!--                    Cabinet login details.-->
                ...
                <div class="login-button" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box; margin: 0 auto; display: table;">
...
<!--                            Login to cabinet-->
            ...
            <div class="cabinet-login-details" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0px 20px;width: 100%; text-align: center;">
                <h1 style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: .67em 0;font-size: 15px;font-family: inherit;font-weight: 500;line-height: 1.1;color: #5a5a5a;margin-top: 20px;margin-bottom: 10px;">
                    <?=lang('liv_acc_htm_07');?>
<!--                    MT4 login details.-->
                </h1>
...
<!--                        MT4 Live Server:-->
                ...
                <div class="download-button" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box; width: 300px;  display: table; margin: 10px auto;">
...
<!--                            Download MT4 desktop platform-->
                               ...
                               <div class="download-button" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-top: 10px; min-width: 300px; display: table; margin: 0 auto;"><a href="https://webterminal.forexmart.com/"> <button type="button" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font: inherit;color: #fff;overflow: visible;text-transform: none;-webkit-appearance: button;cursor: pointer;font-family: inherit;font-size: inherit;line-height: inherit;width: 100%;border: none;padding: 10px 30px;background: #e64e54;">
                            Web Terminal
<!--                            Download MT4 desktop platform-->
                        </button></a></div>
                <div>
