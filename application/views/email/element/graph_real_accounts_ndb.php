...
<div class="container">
    <div class="row">
        <div class="main-dashboard-holder">
            <row>
                <?php
                echo $this->load->view('email/element/real_accounts_widget_ndb', array( 'days' => 30 ), true);
                echo $this->load->view('email/element/real_accounts_widget_ndb', array( 'days' => 60 ), true);
                echo $this->load->view('email/element/real_accounts_widget_ndb', array( 'days' => 180 ), true);
...
<div class="col-md-12 col-dashboard">
    <center> <h4><b>NDB Client Statistics Table</b></h4>  </center>
    <div class="main-chart-holder">

        <table class="table table-bordered">
            <thead>
            <th>Number of registered clients</th>
            <th>Number of clients who received NDB</th>
            <th>Percentage</th>
            </thead>
            <tbody>
            <td><?=$table['registered_clients']?></td>
            <td><?=$table['received_NDB']?></td>
            <td><?=number_format($table['Percentage']*100,2)?>%</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        accounts_option.series[0].name = 'registered from NDB advertising';
