                    ...
                    <div class="main-chart-holder">
                        <div class="chart-header">
                            <div class="chart-title">
                                <h1><i class="fa fa-sign-in"></i>Real Deposits</h1>
                            </div>
                            <div class="chart-action-holder">
                                <a class="cursord" id="most_deposit_expand" title="Expand Widget" ><i class="fa fa-expand"></i></a>
                                <input type="hidden" class="expend dr_graph" name="most_deposit_graph" id="most_deposit_isexpand" value="0"/>
                            </div><div class="clearfix"></div>
                        </div>
                        <div class="chart-holder" id="most_deposit_graph">
                        </div>
                        <div class="chart-footer">
                            <h1>Real Deposits in the last <span id="lbl_most_deposit_period"><?php echo $days ?></span> days</h1>
                            <div class="filter-top-countries">
                                <div class="form-group chart-fg">
                                    <label for="" class="chart-lbl">Country</label>
                                    <select class="chart-option" name="lbl_most_deposit_country" id="lbl_most_deposit_country">
                                        <option value="">All Countries</option>
                                        <?php echo $countries ?>
                                    </select>
                                    <label for="" class="chart-lbl">Period</label>
                                    <select class="chart-option" name="rd10limit" id="most_deposit_period">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var popular_option = {
            ...
            title: {
                text: "Most Popular Deposit Methods"
            },
            tooltip: {
        ...
        var data_7 = [<?php echo implode(",", $most_deposit_chart_data) ?>];
        popular_option.chart.renderTo = 'most_deposit_graph';
        popular_option.series[0].name = 'Deposit Methods';
        popular_option.series[0].colorByPoint = true;
        popular_option.series[0].data = data_7;
        var most_deposit_chart = new Highcharts.Chart(popular_option);
        most_deposit_chart.setTitle({text: 'Real Deposits'});
        most_deposit_chart.redraw();
    });
</script>
</body>
</html>