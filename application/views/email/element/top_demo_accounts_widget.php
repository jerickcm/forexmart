<div class="col-md-12 col-dashboard" id="top_demo_accounts_graph_<?php echo $days ?>">
    <div class="main-chart-holder">
        <div class="chart-header">
            ...
            <div class="chart-action-holder">
                <a href="#" class="cursord" id="top_demo_expand" title="Expand Widget" ><i class="fa fa-expand"></i></a>
                <input type="hidden" class="expend dr_graph" name="top_demo_graph" id="top_demo_accounts_expand" value="0"/>
            </div><div class="clearfix"></div>
        </div>
        <div class="chart-holder" id="top_demo_account_graph">
        </div>
        <div class="chart-footer">
            <h1>Opened account in the last <span id="lbl_top_demo_period"><?php echo $days ?></span> days</h1>
            ...
            <div class="filter-top-countries">
                <div class="form-group chart-fg">
                    ...
                    <select class="chart-option" name="top_demo_accounts" id="top_demo_cumulative_<?php echo $days ?>">
                        <option value="1">YES</option>
                        <option selected value="0">NO</option>
                    </select>
                    &nbsp;&nbsp;&nbsp;
                    <label for="" class="chart-lbl">Period</label>
                    <select class="chart-option" name="top_demolimit" id="top_demo_period_<?php echo $days ?>">
                    ...
                    Total Account: <span id="lbl_total_demo_country"><?php echo $total_country_count ?></span>
                </div>
            </div>
