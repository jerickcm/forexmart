        ...
        <div class="main-dashboard-holder">
            <row>
                ...
                foreach($period as $days){
                    ...
                    echo $this->load->view('email/element/demo_accounts_widget', $view_data, true);
                }
                ?>
            </row>
        </div>
...
<form method="POST" enctype="multipart/form-data" id="demoGraphForm">
    <input type="hidden" name="img_val_30" id="img_demo_val_30" value="" />
    <input type="hidden" name="img_val_60" id="img_demo_val_60" value="" />
    <input type="hidden" name="img_val_180" id="img_demo_val_180" value="" />
    <input type="hidden" name="img_val_360" id="img_demo_val_360" value="" />
    <input type="hidden" name="img_val_540" id="img_demo_val_540" value="" />
</form>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var data_30 = [<?php echo implode(",", $demo_accounts_data_30) ?>];
        accounts_option.chart.renderTo = 'demo_account_graph_30';
        accounts_option.series[0].name = 'Demo Accounts';
        accounts_option.series[0].color = '#d04437';
        accounts_option.series[0].data = data_30;
        var demo_accounts_chart_30 = new Highcharts.Chart(accounts_option);
        demo_accounts_chart_30.setTitle({text: 'Demo Accounts Graph'});

        var data_60 = [<?php echo implode(",", $demo_accounts_data_60) ?>];
        accounts_option.chart.renderTo = 'demo_account_graph_60';
        accounts_option.series[0].name = 'Demo Accounts';
        accounts_option.series[0].color = '#d04437';
        accounts_option.series[0].data = data_60;
        var demo_accounts_chart_60 = new Highcharts.Chart(accounts_option);
        demo_accounts_chart_60.setTitle({text: 'Demo Accounts Graph'});

        var data_180 = [<?php echo implode(",", $demo_accounts_data_180) ?>];
        accounts_option.chart.renderTo = 'demo_account_graph_180';
        accounts_option.series[0].name = 'Demo Accounts';
        accounts_option.series[0].color = '#d04437';
        accounts_option.series[0].data = data_180;
        var demo_accounts_chart_180 = new Highcharts.Chart(accounts_option);
        demo_accounts_chart_180.setTitle({text: 'Demo Accounts Graph'});

        var data_360 = [<?php echo implode(",", $demo_accounts_data_360) ?>];
        accounts_option.chart.renderTo = 'demo_account_graph_360';
        accounts_option.series[0].name = 'Demo Accounts';
        accounts_option.series[0].color = '#d04437';
        accounts_option.series[0].data = data_360;
        var demo_accounts_chart_360 = new Highcharts.Chart(accounts_option);
        demo_accounts_chart_360.setTitle({text: 'Demo Accounts Graph'});

        var data_540 = [<?php echo implode(",", $demo_accounts_data_540) ?>];
        accounts_option.chart.renderTo = 'demo_account_graph_540';
        accounts_option.series[0].name = 'Demo Accounts';
        accounts_option.series[0].color = '#d04437';
        accounts_option.series[0].data = data_540;
        var demo_accounts_chart_540 = new Highcharts.Chart(accounts_option);
        demo_accounts_chart_540.setTitle({text: 'Demo Accounts Graph'});
    });
</script>
</body>
</html>