                    ...
                    <div class="main-chart-holder">
                        <div class="chart-header">
                            <div class="chart-title">
                                <h1><i class="fa fa-sign-in"></i>Most Popular Deposit Methods </h1>
                            </div>
                            <div class="chart-action-holder">
                                <a class="cursord" id="popular_deposit_expand" title="Expand Widget" ><i class="fa fa-expand"></i></a>
                                <input type="hidden" class="expend dr_graph" name="popular_deposit_graph" id="popular_deposit_isexpand" value="0"/>
                            </div><div class="clearfix"></div>
                        </div>
                        <div class="chart-holder" id="popular_deposit_graph">
                        </div>
                        <div class="chart-footer">
                            <h1>Most Popular Deposit Method in the last <span id="lbl_popular_deposit_period"><?php echo $days ?></span> days</h1>
                            <div class="filter-top-countries">
                                <div class="form-group chart-fg">
                                    <label for="" class="chart-lbl">Period</label>
                                    <select class="chart-option" name="rd10limit" id="popular_deposit_period">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var data_6 = [<?php echo implode(",", $popular_deposit_chart_data) ?>];
        popular_option.chart.renderTo = 'popular_deposit_graph';
        popular_option.series[0].name = 'Deposit Methods';
        popular_option.series[0].colorByPoint = true;
        popular_option.series[0].data = data_6;
        var popular_deposit_chart = new Highcharts.Chart(popular_option);
        popular_deposit_chart.setTitle({text: 'Most Popular Deposit Methods'});
        popular_deposit_chart.redraw();
    });
</script>
</body>
</html>