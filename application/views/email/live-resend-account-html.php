...
<!--                    Cabinet login details.-->
                ...
                <div class="login-button" style="cursor:pointer;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;"><a href="https://my.forexmart.com/client/signin"><button type="button" style="cursor:pointer;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font: inherit;color: #fff;overflow: visible;text-transform: none;-webkit-appearance: button;cursor: pointer;font-family: inherit;font-size: inherit;line-height: inherit;width: 100%;border: none;padding: 10px 30px;background: #29a643;">
                            <?=lang('liv_acc_htm_06');?>
<!--                            Login to cabinet-->
                        </button></a></div>
            </div>
...
<!--                        MT4 Live Server:-->
                ...
                <div class="download-button" style="cursor:pointer;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;"><a href="https://download.mql5.com/cdn/web/tradomart.ltd/mt4/forexmart4setup.exe"> <button type="button" style="cursor:pointer;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font: inherit;color: #fff;overflow: visible;text-transform: none;-webkit-appearance: button;cursor: pointer;font-family: inherit;font-size: inherit;line-height: inherit;width: 100%;border: none;padding: 10px 30px;background: #2988ca;">
                            <?=lang('liv_acc_htm_13');?>
...
<!--                To express our gratitude for jump-starting your trading with us, you can avail of the 30%-->
                <a href="<?=FXPP::loc_url('bonuses')?>" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;background-color: transparent;color: #2988ca;text-decoration: underline;">
                    <?=lang('liv_acc_htm_16');?>
<!--                    Bonus-->
                </a>
                <?=lang('liv_acc_htm_17');?>
...
<!--                For more information, please do not hesitate to contact us at-->
                ...
                <a href="javascript:;" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;background-color: transparent;color: #2988ca;text-decoration: underline;">
