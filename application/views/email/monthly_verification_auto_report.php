    ...
    <div class="wrapper-body" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;padding: 10px 0;margin-top: 3px;border-top: 1px solid #2988ca;border-bottom: 1px solid #2988ca;padding-bottom: 20px; display: inline-block">
        ...
        <table cellspacing="0" border="1">
            ...
            <tr>
                ...
                <td><?php echo $accounts_verified_month ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold">Declined Applications</td>
                <td><?php echo $accounts_declined_month ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold">Pending Applications</td>
                <td><?php echo $accounts_pending_month ?></td>
            </tr>
            <tr>
                <td style="font-weight: bold">Percentage of verified accounts</td>
                <td>
                    <?php
                    $percentage_verified = $accounts_verified_month > 0 ? ($accounts_verified_month / ($uploaded_documents_month + $old_uploaded_documents_month)) * 100 : 0;
            ...
            <tr>
                ...
                <td>
                    <?php
                    $percentage_declined = $accounts_declined_month > 0 ? ($accounts_declined_month / ($uploaded_documents_month + $old_uploaded_documents_month)) * 100 : 0;
            ...
            <tr>
                ...
                <td>
                    <?php
                    $percentage_pending = $accounts_pending_month > 0 ? ($accounts_pending_month / ($uploaded_documents_month + $old_uploaded_documents_month)) * 100 : 0;
