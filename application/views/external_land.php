                ...
                <a class="btn btn-primary dropdown-toggle fx-btn-primary" data-toggle="dropdown" href="#">
                    <?php switch(FXPP::html_url()){
                        ...
                        case 'ru': ?>
                            ...
                            <?php break;
                        case 'id': ?>
                            <img id="img-src" src="<?=base_url()?>assets/landing_v2/images/flags/indonesian.png"/>
                            <?php break;
                    ...
                    <div class="btn-group fx-btn-group">
                        <a class="btn btn-primary dropdown-toggle fx-btn-primary" data-toggle="dropdown" href="#">
                            ...
                            <?php switch(FXPP::html_url()){
                                ...
                                case '':
                                    ?>
                                    <img id="img-src" src="<?=base_url()?>assets/landing_v2/images/flags/english.png"/>
                                    <?php break;
                                case 'ru': ?>
                                    <img id="img-src" src="<?=base_url()?>assets/landing_v2/images/flags/russian.png"/>
                                    <?php break;
                                case 'id': ?>
                                    <img id="img-src" src="<?=base_url()?>assets/landing_v2/images/flags/indonesian.png"/>
                                    <?php break;
