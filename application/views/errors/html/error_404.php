...
<div class="not-found-holder">
    <div class="container">
        ...
        <div class="error-form-holder">
            <div class="error-image-holder">
                <img src="<?= $site_www?>/assets/images/404bg.png" class="img-responsive first-error-image"/>
                <img src="<?= $site_www?>/assets/images/404bg_2.png" class="img-responsive secondary-error-image"/>
                <p class="absolute-text">Check out our <a href="<?= $site_www?>faq">FAQ</a> for help, or go to <a href="<?= $site_www?>">Home page</a>.</p>
                <div class="error-other-text">
                    <span>We can't find the page you are looking for</span>
                    <p>Check out our <a href="<?= $site_www?>faq">FAQ</a> for help, or go to <a href="<?= $site_www?>">Home page</a>.</p>
                </div>
            </div>
        </div>
