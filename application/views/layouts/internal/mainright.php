    ...
    <div id="fix-menu" class="fix-menu">
        <a class="opt" href="#">
            <div class="input-group">
                    <span data-original-title="LiveChat" class="input-group-addon fix-icon2" data-toggle="tooltip" data-placement="left" title="LiveChat">
...
<!--            <div class="input-group">-->
<!--                    <span data-original-title="Feedback" class="input-group-addon fix-icon3" data-toggle="tooltip" data-placement="left" title="Feedback">-->
