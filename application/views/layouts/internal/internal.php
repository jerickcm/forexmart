                ...
                <form class="navbar-form navbar-left" role="search">
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control round-0" id="exampleInputAmount" placeholder="<?= lang('search') ?>">
                            <div class="input-group-addon round-0"><i class="fa fa-search"></i></div>
                        </div>
                    </div>
                </form>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img src="<?= $this->template->Images()?>avatar.png" class="img-responsive" alt="" width="30" style="float: left; margin-right: 8px; margin-top: -5px;"> Sample User <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?=FXPP::loc_url('accounts')?>">My Account</a></li>
                        <li><a href="#">My Profile</a></li>
                        <li><a href="#">Deposit Funds</a></li>
                        <li><a href="#">Withdraw Funds</a></li>
                        <li><a href="#">Platform Downloads</a></li>
                        <li class="divider"></li>
                        <li><a href="#">Log Out</a></li>
                    </ul>
                </li>
                <li><a href="#"><img src="<?= $this->template->Images()?>flag.png" class="img-reponsive" alt="" width="30"></a></li>
            </ul>s
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
        ...
        <div class="dl-holder">
            ...
            <div class="dls">
                ...
                <ul class="platforms">
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx1.png" class="img-reponsive" width="50" height="50" alt="" style="float: left;">
                            ForexMart Client Terminal<br><cite>MT4 Platform</cite>
                        </a>
                    </li><div class="clearfix"></div>
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx2.png" class="img-reponsive" alt="" width="50" height="50" style="float: left;">
                            ForexMart MultiTerminal<br><cite>Multi-MT4</cite>
                        </a>
                    </li><div class="clearfix"></div>
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx3.png" class="img-reponsive" width="50" height="50" alt="" style="float: left;">
                            ForexMart WebTrader<br><cite>MT4 Online</cite>
                        </a>
                    </li><div class="clearfix"></div>
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx4.png" class="img-reponsive" width="50" height="50" alt="" style="float: left;">
                            ForexMart iPhone<br><cite>Trader</cite>
                        </a>
                    </li><div class="clearfix"></div>
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx5.png" class="img-reponsive" width="50" height="50" alt="" style="float: left;">
                            ForexMart iPad<br><cite>Trader</cite>
                        </a>
                    </li><div class="clearfix"></div>
                    <li>
                        <a href="#">
                            <img src="<?= $this->template->Images()?>fx6.png" class="img-reponsive" width="50" height="50" alt="" style="float: left;">
    ...
    <div class="col-lg-9 col-md-9 col-sm-9">
        <div class="section">
            <div class="side-nav-holder">
                <ul class="side-nav">
                    <li><a href="<?=FXPP::loc_url()?>accounts" class="active-sidenav"><i class="fa fa-suitcase"></i><cite>My Account</cite></a></li>
                    <li><a href="#"><i class="fa fa-user"></i><cite>My Profile</cite></a></li>
                    <li><a href="#"><i class="fa fa-money"></i><cite>Deposit Funds</cite></a></li>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="connect-holder">
            ...
            <ul>
                <li>
                    <a href="">
                        <img src="<?= $this->template->Images()?>circle3.png" width="40" alt=""/> Help Center
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="<?= $this->template->Images()?>live.png" width="40" alt=""/> Live Chat
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="<?= $this->template->Images()?>contact.png" width="40" alt=""/> Call Me Back
                    </a>
                </li>
            </ul><div class="clearfix"></div>
        </div>
        <div class="follow-holder">
            ...
            <ul>
                <li>
                    <a href="" class="gplus"><img src="<?= $this->template->Images()?>gplus.png" width="30"></a>
                </li>
                <li>
                    <a href="<?= $this->config->item('domain-facebook');?>" class="fb" target="_blank"><img src="<?= $this->template->Images()?>fb.png" width="30" alt=""></a>
                </li>
                <li>
                    <a href="" class="in"><img src="<?= $this->template->Images()?>linkedin.png" width="30px"></a>
                </li>
                <li>
                    <a href="<?= $this->config->item('domain-twitter');?>" class="twit" target="_blank"><img src="<?= $this->template->Images()?>twitter.png" width="30" alt=""></a>
                </li>
            </ul><div class="clearfix"></div>
        </div>
    </div>
...
<div class="row" style="border-top: 1px solid #2988CA; padding: 10px; 0">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ul class="other-link">
            ...
            <li><a href=" <?php echo FXPP::loc_url('privacy-policy')?>">Privacy Policy</a></li>
