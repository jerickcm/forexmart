...
<!-- modal -->
<link href="<?= $this->template->Css()?>modal_feedback.css" rel="stylesheet">
        ...
        <div  class="modal-content round-0 modalfeedbackcontent">
            <div class="modal-header popheader">
                ...
                <div class="modal-title poptitle" id="myModalLabel">
                    <img src="<?= $this->template->Images()?>fxlogonew.svg"  width="400" alt="logo" class="img-reponsive fmodal">
                </div>
            </div>
