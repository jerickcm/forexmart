    ...
    <div class="container">
        <div class="row customrow">
                <div id=registerform" class="col-md-8 col-centered "">
                    <?= form_open('confirm/code',array('id' => 'confirmForm','class'=> ''),''); ?>
                            ...
                            <?php if(!is_null($custom_validation_success)){ ?>
                                <div class="form-group">
                                    <div class="col-md-8 col-centered "">
                                        ...
                                        <p><b>Server:</b> <?=MONEYFALL_SERVER_DEMO;?></p>
...
<script type='text/javascript'>
    ...
    $( ".achievecenter" ).mouseover(function() {
        $( "#ConfirmationCode").val($.trim($("#ConfirmationCode").val()));
    });
    $().ready(function() {
