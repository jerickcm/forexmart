    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <a href="<?php echo FXPP::www_url('feed/news/'.$lan) ?>" class="rss-icon"> <img src="<?= $this->template->Images()?>rss-icon.png" alt="" class="img-rss" ></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <div class="latest-info-holder">
                                    <h2><a style="color: #ffffff;" href="<?php echo FXPP::ajax_url('news/article/' . $value['id']) ?>" target="_blank"><?php echo $value['headline'] ?></a></h2>
                                    ...
                                    <p>
                                        ...
                                        <a href="<?php echo FXPP::ajax_url('news/article/' . $value['id']) ?>"> <?=lang('news_2');?></a>
                                    </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-10 latest-list-info">
                                    ...
                                    <p>
                                        ...
                                        <a href="<?php echo FXPP::ajax_url('news/article/' . $news['id']) ?>"><?=lang('news_2');?></a>
                                    </p>
    ...
    <div class="container">
        <div class="all-news-holder">
            <div class="row">
                ...
                <div id="all_news">
                    <?php $this->load->view('news/all_news')?>
                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $(document).on('click','#latest-news-links .pagination a:not(#curPage)',function(event){
            ...
            $.ajax({
                type: 'POST',
                url: site_url+'news/latest_news/'+page,
                beforeSend:function(){
                    $('#loader-holder').show();
                ...
                $.each(obj, function(i,value){
                    ...
                    title.href = "<?=FXPP::ajax_url('news/article') ?>/"+value.id;
                    title.target = "_blank";
                    ...
                    content_holder.innerHTML = content_content.replace(/(<([^>]+)>)/ig,"").substr(0,70)+ '... <a href="<?=FXPP::ajax_url('news/article') ?>/'+value.id+'">Read More </a>';
...
//most read
        ...
        $(document).on('click','#most-read-links .pagination a:not(#currentPage)',function(event){
            ...
            $.ajax({
                type: 'POST',
                url: site_url+'news/most_read/'+page,
                beforeSend:function(){
                    $('#loader-holder').show();
