                        ...
                        ?>
                            <div class="item <?php echo ($ctr == 0) ? 'active' : '' ?>">
                                <div class="forex-news-content">
                                    <a href="<?php echo FXPP::loc_url('news/article/' . $value['id']) ?>" target="_blank"><?php echo $value['headline'] ?></a>
                                    ...
                                    <a href="<?php echo FXPP::loc_url('news/article/' . $value['id']) ?>" class="read-more-button">
                                        <?=lang('n_0_6');?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="column-article-news ext-arabic-column-article-news col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="column-article-header ext-arabic-column-article-header">
                                    ...
                                    <div class="column-article-information">
                                        <a href="<?php echo FXPP::loc_url('news/article/' . $top_latest_news['id']) ?>" target="_blank"><?php echo $top_latest_news['headline'] ?></a>
                                ...
                                <div class="column-article-content ext-arabic-column-article-content">
                                    ...
                                    <a href="<?php echo FXPP::loc_url('news/article/' . $top_latest_news['id']) ?>" target="_blank" class="read-more-button"><?=lang('n_0_4');?></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 news-archive">
                    <ul id="ul-archive-news">
                        ...
                        <li>
                            ...
                            <p><?php echo $news['summary'] ?> <a href="<?php echo FXPP::loc_url('news/article/' . $news['id']) ?>"><?=lang('n_0_4');?>...</a></p>
                        </li>
                        <?php
                        }
                        ?>
                                    ...
                                    <div class="tab-news-list ext-arabic-tab-news-list">
                                        <ul id="ul-latest-news" class="recent-list-news">
                                            ...
                                            foreach( $latest_news as $key => $news ){
                                                ?>
                                                <li>
                                                    <a href="<?php echo FXPP::loc_url('news/article/' . $news['id']) ?>" target="_blank"><?php echo $news['headline'] ?></a>
...
<script language="JavaScript" type="text/javascript">
    ...
    jQuery(document).on('click', '.latest-page a', function(e){
        ...
        jQuery.ajax({
            type: "POST",
            url: baseURL + "news/updateLatestPage/" + cur_page,
...
//                jQuery('#updatesCurrentPage').val(cur_page);
    ...
    jQuery(document).on('click', '.most-read-page a', function(e){
        ...
        jQuery.ajax({
            type: "POST",
            url: baseURL + "news/updateMostReadPage/" + cur_page,
            data: {cur_page : cur_page},
            dataType: 'JSON',
            cache: false,
            success: function(page) {
//                jQuery('#updatesCurrentPage').val(cur_page);
    ...
    jQuery(document).on('click', '.archive-page a', function(e){
        ...
        jQuery.ajax({
            type: "POST",
            url: baseURL + "news/updateArchivePage/<?php echo $top_latest_news['id'] ?>/" + cur_page,
            data: {cur_page : cur_page},
            dataType: 'JSON',
            cache: false,
            success: function(page) {
