        ...
        <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            <ul class="demo-feats">
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_cpa_li1-0')?></span>
                                    <span class="clearfix"></span>
                                <!-- No complex computation, process, or requirement -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_cpa_li1-1')?></span>
                                    <span class="clearfix"></span>
                                <!-- Highly competitive, transparent commission -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_cpa_li1-2')?></span>
                                    <span class="clearfix"></span>
                                <!-- Fast and easy one-time payout -->
                                </li>
                                <!-- <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_cpa_li1-3')?></span>
                                    <span class="clearfix"></span> -->
                                <!-- Client base expansion – guaranteed! -->
                                <!-- </li> -->
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_cpa_li1-4')?></span>
                                    <span class="clearfix"></span>
                                <!--  No need to learn the market -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_fr_li1-2')?></span>
                                    <span class="clearfix"></span>
                                <!-- Affiliate Link -->
                                </li>
                            </ul>
            ...
            <div class="col-lg-12">
                ...
                <div class="partner-tab-holder ext-arabic-license-title">
                    <?php
                    $flash = $this->session->flashdata("successlocalop");
                    if(!isset($flash)) {
                        ?>
                        <div class="btn-hold-div">
                            <button id="btnCommissions" class="btn-comm-table">*<?=lang('x_cpa_li1-5')?></button>
                        </div>

                        <div id="tblCommissions" class="table-responsive ref-reg-holder" style="display: none;">
                            <table id="forexTable" class="table table-bordered ins-table">
                                <thead>
                                <tr>
                                    <th class="ins-table"><?=lang('acct-ipa')?></th>
                                    <th class="ins-table" colspan="4"><?=lang('x_cpa_li1-6')?></th>
                                </tr>
                                <tr>
                                    <th>&nbsp;</th>
                                    <th class="ins-table">$50 - $500</th>
                                    <th class="ins-table">$501 - $2500</th>
                                    <th class="ins-table">$2501 - $10000</th>
                                    <th class="ins-table"> > $10000</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                        ...
                        <p id="tblCommissionsLegend" class="ins-text-sub" style="display: none;">
                            <span class="legend">*</span> <?=lang('x_cpa_fn-0');?><br>
                        </p>
                        <div class="ref-reg-holder partnership-reg-holder">
                            <h1>
                                <?=lang('x_cpa_p1-h')?>
                            </h1>
                            <p>
                            ...
                            <form action="<?= FXPP::www_url('Partnership/cpa');?>" id="local_office_partner_reg" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners ">
                                        ...
                                        <div class="input-group ig company-field ">
                                            <input type="text" name="company_name" id="company_name" value="<?php echo set_value('company_name');?>" class="latin inp-company-field form-control round-0 margin-ref <?=(form_error('company_name') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* <?=lang('x_pr_01')?>"/>
                                            <div class="error_p" id="error_company_name"><?php echo form_error('company_name'); ?></div>
                                        </div>
                                        <div class="input-group ig company-field">
                                            <input type="text" name="registration_number" id="registration_number" value="<?php echo set_value('registration_number');?>" class="latin inp-company-field form-control round-0 margin-ref <?=(form_error('registration_number') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* <?=lang('x_pr_02')?>"/>
                                    ...
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?>  ext-arabic-column-partners ">
                                        ...
                                        <?php }else{ ?>
                                            <div class="input-group ig">
                                                ...
                                                $attr = 'id="currency" class="select-box inp-first-val form-control round-0 margin-ref ext-arabic-form-control-select-text'.$error_c.'"';
                                                ?>
                                        ...
                                        <div class="input-group ig">
                                            ...
                                            $attr = 'id="target_country" class="inp-first-val form-control round-0 margin-ref ext-arabic-form-control-select-text'.$error_tc.'"';
                                            if(IPLoc::Office()){
                                    ...
                                    <div class="btn-cls-sub col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?>  ext-arabic-column-partners">
                                        <div class="input-group ig">
...
<script>
    console.log('<?=$this->session->flashdata("testing")?>');
</script>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("head").append($("<link rel='stylesheet' href='<?= $this->template->Css()?>view-partnership-cpa.css' type='text/css'  />"));
    });
</script>
...
//        });
        ...
        jQuery('#btnCommissions').click(function(){
            jQuery('#tblCommissions').toggle();
            jQuery('#tblCommissionsLegend').toggle();
            if(jQuery('#tblCommissions').is(':visible')){
                jQuery('#btnCommissions').addClass('ins-active');
            }else{
                jQuery('#btnCommissions').removeClass('ins-active');
            }
        });
        ...
        jQuery('div#cpa').on("focus",'input, select, textarea',function(){
        ...
        jQuery('form#local_office_partner_reg').on('click', '#btn-complete-reg', function(){
            var submit = true;
            ...
            if(submit){
                if($("#agree-checkbox").is(':checked')){
                    $('#local_office_partner_reg').submit();
                }else{
                ...
                for(error in errors){
                    switch (errors[error]){
                        ...
                        case 'target_country':
                            ...
                            break;
//                        case 'empty-website':
//                            jQuery("#error_websites").html( "<p>The Website field is required.</p>" );
//                            break;
                        case 'status_type':
...
//            var website_html = '<li><a href="' + website + '">' + website + '</a><a  style="cursor: pointer; margin-left: 10px;" title="Remove Website"><i class="remove-website glyphicon glyphicon-remove"></i></a><input type="hidden" name="websites[]" value="' + website + '" /></li>';
    ...
    $('#forexTable').DataTable({
        ...
        "ordering": false,
        "info":     false,
        dom: '<"ins-filter"<<"coli"><"form-inline"f>>>',
        language: {
            search: "<?=lang('search');?>:",
