                ...
                <div class="partner-tab-holder ext-arabic-license-title">
                    ...
                    if(!isset($flash)) {
                        ...
                        <div class="ref-reg-holder ext-arabic-ref-reg-holder">
                            ...
                            <form action="<?= FXPP::www_url('Partnership/local_office_partner');?>" id="local_office_partner_reg" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners">
                                        ...
                                        <div class="input-group ig company-field">
                                            <input type="text" name="company_name" id="company_name" value="<?php echo set_value('company_name');?>" class="latin inp-company-field form-control round-0 margin-ref <?=(form_error('company_name') == '') ? '' : 'red-border';?>" placeholder="* Company Name"/>
...
//        });
        ...
        jQuery('div#local_office_partner_cont').on("focus",'input, select, textarea',function(){
