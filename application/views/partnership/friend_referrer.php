                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            <ul class="demo-feats">
                                <li><i class="fa fa-check sa-flt-r"></i>
                                     <span class="li_span sa-li_span90"><?= lang('x_fr_li1-0');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?= lang('x_fr_li1-1');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                            ...
                            <ul class="demo-feats">
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?= lang('x_fr_li2-0');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?= lang('x_fr_li2-1');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?= lang('x_fr_li2-2');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?= lang('x_fr_li2-3');?></span>
                                    <span class="clearfix"></span>
                                </li>
                            </ul>
                        </div>
               ...
               <?php
                    ...
                    if(!isset($flash))
                    {
                        ...
                        <div class="ref-reg-holder ext-arabic-ref-reg-holder partnership-reg-holder">
                            ...
                            <form action="<?= FXPP::www_url('Partnership/friend-referrer');?>" id="friend_referrer_reg" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners">
                                        ...
                                        <div class="input-group ig company-field">
                                            <input type="text" name="registration_number" id="registration_number" value="<?php echo set_value('registration_number');?>" class="latin inp-company-field form-control round-0 margin-ref <?=(form_error('registration_number') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* Registration Number"/>
                                            <div class="error_p" id="error_registration_number"><?php echo form_error('registration_number'); ?></div>
                                        </div>
                                        <div class="input-group ig company-field">
                                            <input type="text" name="date_of_inc" id="date_of_inc" value="<?php echo set_value('date_of_inc');?>" class="latin inp-company-field datepicker form-control round-0 margin-ref <?=(form_error('date_of_inc') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* Date of Incorporation"/>
                                            <div class="error_p" id="error_date_of_inc"><?php echo form_error('date_of_inc'); ?></div>
                                        </div>
                                        <div class="input-group ig">
                                            <input type="text" name="fullname" id="fullname" value="<?php echo set_value('fullname');?>" class="inp-first-val form-control round-0 margin-ref <?=(form_error('fullname') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* <?=lang('x_pr_04')?>" />
                                            <div class="error_p" id="error_fullname"><?php echo form_error('fullname'); ?></div>
                                        </div>
                                        <div class="input-group ig">
                                            <input type="email" name="email" id="email" value="<?php echo set_value('email');?>" class="latin_email inp-first-val form-control round-0 margin-ref <?=(form_error('email') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* <?=lang('x_pr_05')?>"/>
                                        ...
                                        <div class="input-group ig">
                                            ...
                                            <input type="text" name="phone_number" id="phone_number" value="<?php echo $calling_code;?>" class="latin_phone inp-first-val form-control round-0 margin-ref <?=(form_error('phone_number') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" placeholder="* Phone Number"/>
                                            <div class="error_p" id="error_phone_number"><?php echo form_error('phone_number'); ?></div>
                                        </div>

                                        <div class="input-group ig">
                                            <input type="text" name="skype" id="skype" class="latin_skype form-control round-0 margin-ref ext-arabic-form-control-placeholder" placeholder="Skype"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners">
                                        ...
                                        <div class="input-group ig margin-ref">
                                            <input type="text" class="latin_website websites form-control round-0 <?=(form_error('websites[]') == '') ? '' : 'red-border';?> ext-arabic-form-control-placeholder" name="websites[]" placeholder="<?=lang('x_pr_07');?>">
                                    ...
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners" style="float: right;" id="btn_send">
                                        <div class="input-group ig">


                                                <?php if(IPLoc::isChinaIP()){ ?>
                                                    <button type="button" class="btn-ref-complete ext-arabic-first-partner-tab" id="btn-complete-reg"><?=lang('complete')?></button>
                                                <?php }else{ ?>
                                                    <button type="button" class="btn-ref-complete  ext-arabic-first-partner-tab" id="btn-complete-reg" onclick="goog_report_conversion(); ga('send', 'event', 'button', 'click', 'complete'); return true;"><?=lang('complete')?></button>
...
<link href="<?= $this->template->Css()?>custome-friend-referrer.css" rel="stylesheet">
...
<?= $this->load->ext_view('modal', 'validate-cyrillic-2', '', TRUE); ?>
    ...
    <script type="text/javascript">
        $( document ).ready( function () {
            ...
            $('#friend_referrer_reg').validate({ // initialize the plugin
                rules: {
                    company_name: {
                        regex: cyrillic
                    },
