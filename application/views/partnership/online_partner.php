...
<div class="reg-form-holder">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 b-left" style="min-height: 270px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            ...
                            <h2 class="partner-sub">
                                <?=lang('x_op_st1')?>
                                    <!-- Benefits for Online Partners: -->
                            </h2>
                            <ul class="demo-feats">
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_op_li1-0')?></span>
                                    <span class="clearfix"></span>
                                    <!--  One of the best commission plan on Market -->
                                    </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_op_li1-1')?></span>
                                    <span class="clearfix"></span>
                                    <!--   Marketing tools and widgets -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_op_li1-2')?></span>
                                    <span class="clearfix"></span>
                                   <!--  24/5 assistance (chat and email) -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_op_li1-3')?></span>
                                    <span class="clearfix"></span>
                                  <!--   Automatic payments -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
                                    <span class="li_span sa-li_span90"><?=lang('x_op_li1-4')?></span>
                                    <span class="clearfix"></span>
                                   <!--  Wide opportunities for statistics' analysis -->
                                </li>
                                <li><i class="fa fa-check sa-flt-r"></i>
         ...
         &nbsp; <br>
            <div class="col-lg-12">
                <div class="partner-tab-holder ext-arabic-license-title">
                    ...
                    <?php
                    $flash = $this->session->flashdata("successop");
                    if(!isset($flash)) {
                        ?>
                        <div class="ref-reg-holder ext-arabic-ref-reg-holder partnership-reg-holder">
                            ...
                            <form action="<?= FXPP::www_url('Partnership/online_partner');?>" id="online_partner_reg" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 <?= (FXPP::html_url()=='sa')? 'col-sm-12 col-xs-12' :''; ?> ext-arabic-column-partners">
                                        <div class="input-group ig">
                                            <textarea  id="message" name="message" class="latin form-control round-0 margin-ref <?=(form_error('message') == '') ? '' : 'red-border';?>" rows="6" placeholder="<?=lang('x_pr_09')?>"><?php echo set_value('fullname');?></textarea>
                                        </div>
                                        <div class="input-group ig">
...
//        });
        ...
        jQuery('div#online_partner_cont').on("focus",'input, select, textarea',function(){
        ...
        jQuery('form#online_partner_reg').on('click', '#btn-complete-reg', function(){
            var submit = true;
...
<?= $this->load->ext_view('modal', 'validate-cyrillic-2', '', TRUE); ?>
    ...
    <script type="text/javascript">
        $( document ).ready( function () {
            ...
            $('#online_partner_reg').validate({ // initialize the plugin
                rules: {
                    company_name: {
                        regex: cyrillic
                    },
