                            ...
                            <ul class="demo-feats">
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_0');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_1');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_2');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_3');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_4');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
                                      <span class="li_span sa-li_span90"><?= lang('pw_li_5');?></span>
                                    <span class="clearfix"></span>
                                </li>
                                <li>
                                    <i class="fa fa-check sa-flt-r"></i>
...
<?= $this->load->ext_view('modal', 'validate-cyrillic-2', '', TRUE); ?>
    ...
    <script type="text/javascript">
        $( document ).ready( function () {
            ...
            $('#webmaster_reg').validate({ // initialize the plugin
                rules: {
                    company_name: {
                        regex: cyrillic
                    },
