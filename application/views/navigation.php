...
<!--                                <li><a href="--><?php //echo base_url(); ?><!--transactions/deposit" class="--><?php //if($this->uri->segment(1) != "withdraw-funds") echo "active-sidenav"; ?><!--"><i class="fa fa-money"></i><cite>Deposit Funds</cite></a></li>-->
                                <li><a href="<?php echo base_url(); ?>withdraw-funds" class="<?php if($this->uri->segment(1) == "withdraw-funds") echo "active-sidenav"; ?>"><i class="fa fa-credit-card"></i><cite>Withdraw Funds</cite></a></li>
