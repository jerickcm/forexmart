    ...
    $(document).ready(function () {
        ...
        var ajax_verify = function() {
            ...
            pblc['request'] = $.ajax({
                async: false,
                dataType: 'json',
//                url: site_url + 'query/tagagents',
//                url: site_url + 'query/tag_managerremoved',
//                url: site_url + 'query/getaffcode',
//                url: site_url + 'query/data2',
//                url: site_url + 'query/getaffcodedata2',
                url: site_url + 'query/checkinactiveaccounts',
                method: 'POST',
                data:prvt["data"]
            });
...
//        ajax_verify();
        var x=.1; //.15 9sec .1 6sec .3 18sec
