...
function populate(data,instance) {
    ...
    var y;
    for (y in data['chart']['AUDUSD']) {
        chart_segment_data  += '{"Close":'+data['chart']['AUDUSD'][y]['Ask']+',' +
            '"High":'+data['chart']['AUDUSD'][y]['High']+',' +
            '"Low":'+data['chart']['AUDUSD'][y]['Low']+',' +
            '"Open":'+data['chart']['AUDUSD'][y]['Ask']+',' +
            '"Stamp":"'+data['chart']['AUDUSD'][y]['TimeStamp']+'",' +
            '"Symbol":"'+data['chart']['AUDUSD'][y]['Symbol']+'",' +
            '"TimeFrame":60,' +
            '"Volume":'+data['chart']['AUDUSD'][y]['Spread']+'},';
    }
    var x;
    if (data.r5==false){
...
//            var arr = ['AUDUSD','EURGBP','EURCHF','EURJPY','EURUSD','GBPUSD','NZDUSD','USDCAD','USDCHF','USDJPY'];
            var arr = ['AUDUSD','EURGBP','EURCHF','EURJPY','EURUSD','GBPUSD','NZDUSD','USDCAD','USDCHF','USDJPY','AAPL','AMZN','BAC','BARC','EBAY','FB','GOOG','LNKD','MSFT','YHOO','GOLD','SILVER','XAUUSD','GOLDgr','XAGUSD','Bitcoin' ]; /*all functional symbols  */
//            if (x!='GOLDgr'){
                if ($.inArray(x, arr) != -1){
