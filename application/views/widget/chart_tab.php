                    ...
                    <div class="col-md-12 cpt noright mar-charttop">
                        <?php if($tab == 0){ ?>
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe name="charting" id="charting" class="embed-responsive-item" src="<?php echo fxpp::loc_url('tickchart/update')?>"></iframe>
                            </div>
                        <?php }?>
                    </div>
                </div>
...
//    sessionStorage.setItem('ChartDataGenQuotes', JSON.stringify(chart_data));
}
