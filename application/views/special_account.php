        ...
        <?php }else{ ?>
            ...
            <div class="fm-page-title-desc-holder">
                ...
                <?php if($this->session->userdata('logged')){
                    $msg='<p></p>';
                ?>
                    <button class="btn-link-fm btn-link-copy pull-right sub-unsub" href="javascript()"><i class="fa fa-files-o"></i>
                        <span id="copy">
                ...
                ?>
                    <button  class="btn-link-fm btn-link-copy pull-right"  data-toggle="modal" data-target="#myModal"  title="Please log in your account first">
                        <i class="fa fa-files-o">
                        </i> <?php echo $button_name;?>
                    </button >
                <?php }?>
