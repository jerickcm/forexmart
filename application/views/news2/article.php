...
<!--                </div>-->
            ...
            <div class="forex-news-left-content">
                <div class="news-back-button">
                    <a href="<?php echo FXPP::ajax_url('news2');?>" class=" btn btn-primary"><?= lang('a_0_8');?></a>
                </div>
            </div>
            <!-- end back button-->
                ...
                <div class="list-of-other-news">
                    ...
                    <ul>
                        <?php foreach( $most_read_news as $key => $article){ ?>
                            <li>
                                <a href="<?php echo FXPP::loc_url('news2/article/' . $article['id'].'/'. $article['id2']) ?>"><?php echo $article['headline'] ?> <span>- <?php echo  date('D M j H:i:s e Y', strtotime($article['date_published'])) ?></span></a>
                            </li>
                        <?php }?>
                    </ul>
                </div>
                        ...
                        <div class="thumbnail all-news-thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p>
                                    ...
                                    <a href="<?php echo FXPP::ajax_url('news2/article/' . $news['id'].'/'. $news['id2']) ?>"><?=lang('news_7');?></a>
                                </p>
                            </div>
                        </div>
                    </div>
