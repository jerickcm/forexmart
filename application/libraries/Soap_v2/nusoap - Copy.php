...
NuSOAP - Web Services Toolkit for
...
//			$this->debug("In serializeEnvelope, serialized array of headers to $headers");
	...
	// serialize envelope
   $dataxml = '<?xml version="1.0" encoding="'.$this->soap_defencoding .'"?'.">".
        ...
        "</SOAP-ENV:Body>".
        "</SOAP-ENV:Envelope>";
        $this->debug("XML=" ."<pre>". htmlentities($dataxml) . "</pre>". " ");
        return $dataxml;
	...
	*/
	function serialize_return() {
		...
		if($this->wsdl){
            ...
            $this->debug("XML=" ."<pre>". htmlentities($this->responseSOAP) . "</pre>". " ");
            $this->debug("b");
		} else {
...
//            $this->debug("debug flag=" ."<pre>". htmlentities($this->getDebugAsXMLComment()) . "</pre>". " ");
//            $this->debug("=XML=" ."<pre>". htmlentities($payload) . "</pre>". " ");
        }
        $this->debug("zasdasda ");
...
//        $xml = new SimpleXMLElement($payload);
		print $payload;
//        $this->debug("=payload=" ."<pre>". htmlentities($payload) . "</pre>". " ");
		$this->response = join("\r\n",$this->outgoing_headers)."\r\n\r\n".$payload;
//        $this->debug("=payload=" ."<pre>". htmlentities($this->response ) . "</pre>". " ");
	}
...
//		$this->debug('SOAP message length=' . "<pre>". htmlentities($soapmsg) . "</pre>". ' contents (max 1000 bytes)=' . substr($soapmsg, 0, 1000));
		// send
//        var_dump($soapXml);
//        ob_start();
//        $soapXml = ob_get_contents($soapmsg);
//        ob_end_clean();
//        $soapXml = preg_replace ('/[^\x{0009}\x{000a}\x{000d}\x{0020}-\x{D7FF}\x{E000}-\x{FFFD}]+/u', ' ', $soapXml);

		$return = $this->send($this->getHTTPBody($soapmsg),$soapAction,$this->timeout,$this->response_timeout);
        $this->debug("after send");
