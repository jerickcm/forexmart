...
class IPLoc{
	public static function bonus(){
		...
		$data['c11_100'] = array('AD','AU','AT','BE','CA','CY','CZ','CS','EE','DK','FO','FI','FR','DE','GR','IS','IE','IL','IT','JP','LU','MT','MC','NZ','NL','NO', 'PT','SM','SG','SK','SI','KR','ES','SE','CH','US');
...
//            '122.54.195.33',
    ...
    public static function ChartIPandVPN(){
        /*Task FXPP-5161 */
        require_once APPPATH.'/helpers/geoiploc.php';
        $ip=FXPP::CI()->input->ip_address();
        if(FXPP::CI()->input->valid_ip($ip)){
...
//            '88.198.94.228'
    ...
    public static function OfficeStrict(){
...
//            '122.54.195.33',
    ...
    public static function OfficeIP_forexchart(){
        require_once APPPATH.'/helpers/geoiploc.php';
        $ip=FXPP::CI()->input->ip_address();
        if(FXPP::CI()->input->valid_ip($ip)){
            $data['Country'] = getCountryFromIP($ip);
