...
<div class="modal fade" id="popLanguagedelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog round-0 ">
        <div  class="modal-content round-0 modalfeedbackcontent">
            <div class="modal-header popheader">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <div class="modal-title poptitle" id="myModalLabel"> Language </div>
            </div>

            <?= form_open('administration/settingslanguagedelete',array('id' => 'form_Languagedelete')); ?>
                <div class="modal-body modal-body1">
                    <p class="check-ps">Are you sure you want to delete "<span id="language_title"></span>" from the list? ?</p>
