...
<!-- modal -->
<div class="modal fade" id="register_restrict2" tabindex="-1" data-backdrop="static" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="close2" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer round-0">
                <button type="button" data-dismiss="modal" id="btnRestrictOk2" class="btn btn-primary round-0">Ok</button>
            </div>
        </div>
    </div>
</div>
