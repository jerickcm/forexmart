...
$lang['s_18-b'] = '殖やした資産を取引して、さらに多くの利益を得てください。口座を開設し、デポジット

するだけで、トレーダーはデポジット高の30％を受け取ることができます。

たとえば、トレーダーが口座に＄100をデポジットすると、それに対しさらに＄30が加

算されます。有高は＄130になります。私たちのボーナスシステムがお客様のデポジット

から正確なボーナス額を算出します。 ';

$lang['s_19-a'] = 'デポジット不要ボーナス  | ForexMart';
