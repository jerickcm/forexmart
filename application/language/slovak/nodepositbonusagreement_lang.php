...
//Please reflect changes in staging website.
...
//$lang['ndba_li33'] = ' The Promotion is only available to new accounts opened within the Promotion’s effectiveness period. This means only ForexMart Standard Accounts opened from October 1, 2015 onwards are eligible.';
//$lang['ndba_li34'] = ' The Company reserves the right to reject requests for the Promotion at our discretion without explanation to the Client.';
...
//$lang['ndba_li61'] = ' The funds resulting from the Promotion can only be withdrawn once all transactions (buying and selling trades) are completed. The total volume must be equal to X*2,5 market lots, where X is the total amount of received bonuses (including cancelled or partly lost bonuses).';
//$lang['ndba_li62'] = ' The Bonus can only be withdrawn in full. Partial withdrawal is prohibited.';
//$lang['ndba_li63'] = ' The Bonus can only be withdrawn through a request to the Company. The email address where all request for withdrawals is to be sent to bonuses@forexmart.com';
//$lang['ndba_li64'] = ' The Client must ensure that the Bonus is fully available in his or her trading account at the moment of request.';
//$lang['ndba_li65'] = ' The Company reserves the right to reject requests at our discretion without explanation to the Client.';
//$lang['ndba_li66'] = ' The profits made from the Promotion may only be withdrawn using verified accounts.';
//$lang['ndba_li67'] = ' The profits made from the No Deposit Bonus can be withdrawn only if it exceeds 20% of the Bonus. Profit exceeding 20% is available for withdrawal.';
//$lang['ndba_li68'] = ' The Client acknowledges the cancellation of the bonus plus 20% of the bonus upon withdrawal of funds from the trading account.';
//$lang['ndba_li69'] = ' The maximum sum available for withdrawal from accounts with No Deposit Bonus doesn&#39;t exceed the amount of initial bonus. This rule does not apply if the profit was derived from real funds deposited by client.';

/*change*/
$lang['ndba_li6_1_1'] = "The necessary conditions of Bonus Profit withdrawal is the Client's own account replenishment (Deposit) in the amount of equal or greater than sum of Bonus Profit.";
