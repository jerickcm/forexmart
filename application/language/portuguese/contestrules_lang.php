...
$lang['ccr_f'] = '6 - 10 place - 50 USD.';
$lang['ccr_legend_0'] = 'All prizes for winners are half-sized accordingly.';
$lang['ccr_legend_1'] = 'O fundo de prêmios é declarado em euros para os cidadãos da União Europeia e em USD para os cidadãos de fora da União Europeia.';
$lang['ccr_legend_2'] = 'A taxa de conversão pode ser aplicada no fundo de prêmios de acordo com a moeda corrente da conta de negociação real.';
...
$lang['ccr_vi2'] = 'The prize funds will be credited to a verified live trading account opened by the winner. The maximum leverage for accounts opened must be up to 1:50.';
