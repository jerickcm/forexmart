...
$lang['tpdba_tit'] ='Bônus de 30%  | Forexmart';
$lang['tpdba_kew'] ='Bônus de 30%  | Forexmart';
$lang['tpdba_dsc'] ='Bônus de 30%  | Forexmart';

/** Contrato de bônus de 30% */

$lang['tpdb_header'] = 'Contrato para participar da promoção de bõnus de 30% do depósito.';
$lang['tpdb_p1'] = '1. Termos Gerais. ';
$lang['tpdb_li1'] = 'Promoção - a promoção do Bônus de 30 % do depósito';
$lang['tpdb_li2'] = 'Bônus - fundos da Empresa creditados na conta do cliente de acordo com este Contrato.';
$lang['tpdb_li3'] = 'Cliente  - qualquer Pessoa que a Empresa aprova para abrir conta sujeita ao Contrato do Cliente.';
$lang['tpdb_li4'] = 'Contrato do Cliente - Termos e Condições aceitos pelo cliente ao cadastrar uma conta.';
$lang['tpdb_li5-1'] = 'Empresa - empresa ForexMart (';
$lang['tpdb_li5-2'] = ') uma empresa constituída e registrada sob a Lei de Empresas da República do Chipre, com o número de registro 266937.';
$lang['tpdb_p1-1']  ='   Ao participar da promoção descrita por este Acordo, o Cliente concorda com todos os termos e condições deste Contrato.';
$lang['tpdb_p2'] = '2. Participação.';
$lang['tpdb_li21'] = ' Cada cliente tem o direito de receber o bônus no valor de 30% do seu depósito em uma conta de negociação com a ForexMart dentro da Promoção. O bônus de 30% para depósito na conta deve ser creditado no prazo de uma semana desde o momento do depósito na conta.';
$lang['tpdb_li22'] = ' Para obter o bônus de 30% é necessário abrir uma nova conta. O número de conta para o Bônus de 30% a cada cliente não é limitad.';
$lang['tpdb_li23'] = ' O cliente tem o direito de receber o bônus de 30% cada vez que depositar fundos em sua conta de negociação. O montante sobre o qual um bônus pode ser acumulados é igual a diferença entre depósitos e retiradas.';
$lang['tpdb_p3'] = '3. Período da Promoção. ';
$lang['tpdb_li31'] = ' A Promoção descrita no presente Contrato é lançada em 1 de  Outubro de 2015.';
$lang['tpdb_li32'] = ' A empresa tem o direito de interromper a Promoção a qualquer momento sem aviso prévio.';
$lang['tpdb_p4'] = ' 4. Condições para receber o bônus.';
$lang['tpdb_li41'] = '  O bônus só pode ser creditado para os fundos, de fato, presentes na conta no momento de considerar o pedido de um bônus. ';
$lang['tpdb_li42'] = '  O Bônus de 30% não pode ser creditado a uma conta que já foi creditada com um bónus de outro tipo (bônus sem depósito).';
$lang['tpdb_li43'] = ' Informações de identificação não são requeridas durante a solicitação para o Bônus de 30%. Mas a empresa se reserva o direito de solicitar documentos de identificação a seu próprio critério.';
$lang['tpdb_p5'] = ' 5. Condições de retirada.';
$lang['tpdb_li51-1'] = ' O Bônus de 30% pode ser retirado após  negociações de compra ou venda forem concluídos. O volume total dos negócios deve ser igual a X*0.3 lotes do mercado, onde X é o volume total dos bônus recebidos (volume total de todos os bônus, incluindo bônus cancelados ou parcialmente perdidos). Para contas abertas em outras moedas, a fórmula é a seguinte:<br>
- X*0,3*1.1 (lotes) para contas em EUR<br>
- X*0,3*1.5 (lotes) para contas em GBP<br>
- X*0,3/50 (lotes) para contas em  RUB.<br>

Apenas o montante total de bônus pode ser retirado, a retirada parcial é impossível. A fim de retirar fundos de bônus de uma conta de negociação, o trader deve enviar o pedido para ';


$lang['tpdb_li51-2'] = 'bonuses@forexmart.com';
$lang['tpdb_li51-3'] = ' A quantidade de bônus deve ester totalmente disponível na conta de negociação no momento em que um gerente considerar o pedido de lretirada. A Empresa reserva-se o direito de recusar o pedido de retirada de bônus sem explicar a razão.';
$lang['tpdb_li52'] = ' O lucro obtido sobre o valor do bônus pode ser retirado sem quaisquer restrições caso estejam preenchidas todas as condições do presente acordo.';
$lang['tpdb_p6'] = ' 6. Cancelamento e correção do bônus.';
$lang['tpdb_li61'] = ' A Empresa se reserva o direito de cancelar o bônus de 30% sem aviso prévio, por isso recomendamos fortemente não usar fundos de bônus no cálculo do lucro em sua estratégia de negociação. A Empresa não é responsável por quaisquer conseqüências do cancelamento do bônus, incluindo Stop Out, pois o bônus é a propriedade da Empresa .*';
$lang['tpdb_li62'] = ' No caso de valor do bônus ser mais de 2000 USD e mais de 10% das negociações são feitas com menos de 0.01 lote mercado, o bônus pode ser reduzido para 1000 USD. No caso de valor do bônus ser de mais de 10000 USD e mais de 10% das negociações são feitas com menos de 0.1 lote mercado, o bônus pode ser reduzido a 3000 USD.';
$lang['tpdb_li63'] = ' O Cliente concorda que a empresa pode cancelar o bônus e corrigir o lucro obtido com ele com uma quantidade igual a soma de bônus, em caso de detecção de quaisquer sinais de abuso do programa de bônus se a conta tiver lucro igual ao depósito sem aviso prévio ou explicação da razão. O cliente admite possíveis riscos da aplicação do presente parágrafo.';
$lang['tpdb_li64'] = ' O Cliente concorda que qualquer retirada de fundos faz com que a quantidade total de todos os fundos de bônus (bônus recebidos menos bônus cancelados) para exceder 30% da margem livre atual na conta de negociação é seguido por cancelamento de parte do bônus igualando a diferença entre esses valores. A fim de evitar o cancelamento do bônus que excede o montante de retirada, por favor, abstenha-se de qualquer retirada se a quantidade de todos os bônus na conta alcança o valor admissível do bônus de boas-vinsdas para a margem livre atual na conta de negociação após a retirada.';
...
$lang['tpdb_p7'] = ' 7. Modificação dos Termos.';
$lang['tpdb_p71'] = '  As condições da promoção podem ser alteradas ou complementadas pela Empresa a seu exclusivo critério. ';
$lang['tpdb_li71'] = ' PA probabilidade de cancelamento errado do bônus dentro da luta contra o uso inescrupuloso do sistema de  sobretaxa de bonificações não excede 10%. *';
...
$lang['tpdb_p8'] = ' Anexo 1';
$lang['tpdb_li81'] = '<b>Example A: Condição de volume total é preenchida</b> <br><br>

Depósito Inicial: US$500.00<br>
Bônus: Depósito Inicial * Bônus de 30% = 500 * 30% = US$150.00<br>
Saldo inicial: US$650.00<br>
Lucro/Perda: US$ 500.00<br>
Volume total negociado: 50 lotes do mercado<br>
Saldo após a negociação: US$650.00 (Equidade inicial) + US$500.00 (Perda/Lucro) = US$1,150.00<br><br>

Condição de retirada: Volume total negociado > X*0.3 lotes do mercado, onde X = valor total do bônus recebido<br><br>

X*0.3 lotes do mercado = US$150.00 (Bonus) * 0.3 lotes do mercado = 45 lotes do mercado<br><br>

Volume total negociado (50 lotes do mercado) > Condição de retirada (45 lotes do mercado)<br><br>

Valor elegível para retirada: US$1,150.00 (Saldo após a negociação)<br><br>';
/** contrato do bônus de 30%  */
