...
$lang['x_forglo_1'] = 'Slovník Forex';
$lang['x_forglo_2'] = 'Zde jsou nejdůležitější pojmy,používané v obchodování na trhu Forex.';

$lang['x_forglo_h'] = 'Forex Trading Terms';

$lang['x_forglo_3'] = '(Ask)';
$lang['x_forglo_4'] = 'cena, za kterou zákazník může zakoupit zajímavou měnu u prodejce (cena prodavače). ';

$lang['x_forglo_5'] = 'Evidenční sázka (Bank rate )';
$lang['x_forglo_6'] = 'Oficialní Evidenční sázka; sázka, za kterou centrální banka je připravena poskytnout úvěr komerčním bankám zemi.';

$lang['x_forglo_7'] = 'Bid';
$lang['x_forglo_8'] = ' Bid je tzv. nabídková cena instrumentu. Cena instrumentu, za kterou obchodník může prodat daný instrument (vstoupit do krátké pozice).';

$lang['x_forglo_9'] = ' Broker ';
$lang['x_forglo_10'] = 'prostředník, který provadět obchodní operace jménem klienta na trhu forex.';

$lang['x_forglo_11'] = 'Carry trade';
$lang['x_forglo_12'] = 'Ve své podstatě je carry trade relativně jednoduchým typem transakce, která obsahuje dvě části. Nejprve si půjčíme finanční instrument za který budeme platit nízký úrok a poté investujeme do finančního instrumentu, který nám bude vynášet vyšší úrok.';

$lang['x_forglo_13'] = 'Smlouva o rozdílu (CFD) ';
$lang['x_forglo_14'] = ' zvláštní obchodní nástroj, který umožňuje finanční spekulace na akcie, komodity a další nástroje, ve skutečnosti bez nákupu.';

$lang['x_forglo_15'] = ' Provize (Сomission) ';
$lang['x_forglo_16'] = ' platba brokeře za provádění obchodní operace';

$lang['x_forglo_17'] = '  Index spotřebitelských cen  ';
$lang['x_forglo_18'] = ' CPI (Consumer Price Index) je statistickou mírou inflace, která je založena na změnu ceny konkrétního souboru zboží.';

$lang['x_forglo_19'] = ' Expertní Poradce (Expert Advisor)';
$lang['x_forglo_20'] = 'automatizovaný skript, který se používá obchodní software, pro řízení pozice a příkazy automaticky bez lidského zásahu.';

$lang['x_forglo_21'] = 'ECB (Evropská Centrální Banka)';
$lang['x_forglo_22'] = ' hlavní regulační organizace finančního systému Evropské Unie';
